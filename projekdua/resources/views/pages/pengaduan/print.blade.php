...
<body>
    ...
    @php
        $totalKorbanJiwa = 0;
        $totalKerusakanInfrastruktur = 0;
        $totalKerusakanMaterial = 0;
    @endphp
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            @php
                $totalKorbanJiwa += $pengaduan->korban_jiwa ?? 0;
                $totalKerusakanInfrastruktur += $pengaduan->kerusakan_infrastruktur ?? 0;
                $totalKerusakanMaterial += $pengaduan->kerusakan_material ?? 0;
            @endphp
            <tr>
                ...
                <td>{{ $pengaduan->korban_jiwa ?? 0 }}</td>
                <td>{{ $pengaduan->kerusakan_infrastruktur ?? 0 }}</td>
                <td>{{ $pengaduan->kerusakan_material ?? 0 }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <th style="font-weight:bold;">{{ $totalKorbanJiwa }}</th>
                <th style="font-weight:bold;">{{ $totalKerusakanInfrastruktur }}</th>
                <th style="font-weight:bold;">{{ $totalKerusakanMaterial }}</th>
                <th></th>
            </tr>
        </tfoot>
    </table>

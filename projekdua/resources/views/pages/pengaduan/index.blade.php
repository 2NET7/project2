                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Korban Jiwa</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kerusakan Infrastruktur</th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kerusakan Material</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $pengaduan->korban_jiwa ?? '-' }}</p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $pengaduan->kerusakan_infrastruktur ?? '-' }}</p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $pengaduan->kerusakan_material ?? '-' }}</p>
                                        </td>
